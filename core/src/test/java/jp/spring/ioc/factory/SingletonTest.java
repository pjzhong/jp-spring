...
class SingletonTest {
  ...
  void singletonTest() {
    ...
    SingletonObj a = (SingletonObj) factory.getBean(TypeUtil.determinedName(SingletonObj.class));
    SingletonObj b = (SingletonObj) factory.getBean(TypeUtil.determinedName(SingletonObj.class));
