...
import jp.spring.ioc.beans.scan.beans.AnnotationInfo;
import jp.spring.ioc.beans.scan.beans.AnnotationInfo.AnnotationClassRef;
import jp.spring.ioc.beans.scan.beans.AnnotationInfo.AnnotationEnumRef;
import jp.spring.ioc.beans.scan.beans.AnnotationInfo.AnnotationParamValue;
import jp.spring.ioc.beans.scan.beans.ClassInfo;
import jp.spring.ioc.beans.scan.beans.ClassInfoBuilder;
import jp.spring.ioc.beans.scan.beans.FieldInfo;
import jp.spring.ioc.beans.scan.beans.FieldInfoBuilder;
import jp.spring.ioc.beans.scan.beans.MethodInfo;
import jp.spring.ioc.beans.scan.beans.MethodInfoBuilder;
